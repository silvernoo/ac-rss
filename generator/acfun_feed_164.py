...
if __name__ == '__main__':
    ...
    response = requests.get('http://api.aixifan.com/searches/channel?channelIds=164&pageNo=1&pageSize=20&sort=4',
                            headers=headers)
    ...
    rss = PyRSS2Gen.RSS2(
        title='Acfun 文章区',
        link='http://www.acfun.tv/v/list164/index.htm',
        description='Acfun 文章区',
        lastBuildDate=datetime.datetime.now(),
        items=items)
    rss.write_xml(open('feed_164.xml', 'w'), encoding='utf-8')
