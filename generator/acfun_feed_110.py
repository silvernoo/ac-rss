...
if __name__ == '__main__':
    ...
    response = requests.get('http://api.aixifan.com/searches/channel?channelIds=110&pageNo=1&pageSize=20&sort=4',
                            headers=headers)
    ...
    rss = PyRSS2Gen.RSS2(
        ...
        items=items)
    rss.write_xml(open('feed_110.xml', 'w'), encoding='utf-8')
